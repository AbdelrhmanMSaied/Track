...
export default async function DashboardPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-6 py-12">
      ...
      <div className="flex flex-wrap items-center justify-between gap-4"><h1 className="text-3xl font-bold">مرحبًا {profile.full_name}</h1><div className="flex gap-3 text-sm font-semibold text-blue-700"><Link href="/career">جواز المسار</Link><Link href="/profile/edit">تعديل الملف الشخصي</Link></div></div>
