...
type Event = { event_id: string; season_id: string; season_name: string; season_status: string; title: string; objective: string; starts_at: string; ends_at: string; venue: string | null; capacity: number | null; status: string; registration_count: number | null; my_team_role: string | null };
